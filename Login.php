                ...
                <div>
                  ...
                  <div id="educationContainer">
                    <div class="input-group mb-3">
                      <span class="input-group-text" style="height: 40px; margin-top: 15px; "
                        id="inputGroup-sizing-sm">Institute</span>
                      <input type="text" class="form-control my-3" aria-label="Sizing example input"
                  ...
                  <button type="button" class="btn btn-outline-primary my-3" onclick="addEducationField()">Add
                    new</button>
