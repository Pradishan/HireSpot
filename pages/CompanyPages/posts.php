                    ...
                    <div class=" h-100 fixed-top overflow-hidden"
                        ...
                        <div class="d-flex flex-column flex-shrink-0 p-3 d-none d-lg-block vh-100 bg-white "
                            ...
                            <ul class="nav nav-pills flex-column mb-auto">
                                <li class="nav-item">
                                    <a href="./companyProfile.php?id=<?php echo $companyID1; ?> " class="nav-link link-body-emphasis" aria-current="page">
                                ...
                                <li>
                                    <a href="./application.php?id=<?php echo $companyID1; ?> " class="nav-link link-body-emphasis">
                    ...
                    <table class="table table-hover bg-white rounded">
                        ...
                        <tbody>
                            ...
                            foreach ($rs as $row) {
                                ...
                                $jobCategory = $row->jobcateogoryID;
                                $jobID = $row->jobID;
                                $date = $row->date;
                                $content = $row->content;
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center p-1">
                                        ...
                                        <a href="../server/deletepost.php?id=<?php echo $jobID . "& compid=" . $companyID; ?>"><button class="btn btn-danger mx-1 p-1">Delete</button> </a>
                                    </td>
                                </tr>
                                <!-- Modal -->
