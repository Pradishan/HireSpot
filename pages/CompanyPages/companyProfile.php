    ...
    <div class="row">
        ...
        <div class="col-11 ml-sm-auto col-lg-10 px-4 " style="padding-top: 70px;z-index: 5;">
                ...
                <div class="bg-white rounded p-3">
                    ...
                    <div class="d-flex align-items-center justify-content-left position-relative "
                        ...
                        <div class="position-absolute top-0 translate-middle" style="padding-left: 20rem">
                            <img src="https://source.unsplash.com/random/5" alt="avatar" width="200px" height="200px"
                                class="rounded-circle me-2 bg-white rounded-circle p-1">
                        </div>
                        <div class="d-flex justify-content-between" style="margin-left: 16rem">
                            <div class="mx-3">
                                <h1>Company name</h1>
                                <p class="text-muted"><i class="fa-solid fa-location-dot me-2"></i>Srilanka | Colombo-10
                                </p>
                            </div>
                            <div class="">
            ...
            <div class="bg-white rounded p-3 " style="margin-top: 9rem">
                ...
                <p class="mx-4 text-muted">Aut tempora facilis saepe eligendi aperiam. Possimus sunt facilis atque iure,
                    minima dolor totam porro nisi ipsa laborum dolores neque assumenda deleniti numquam sed? Atque ullam
                    vitae porro, odio vero impedit voluptatem fugiat id voluptate? Sed sequi eum quam saepe. Sequi
                    quisquam commodi quos tempore cupiditate debitis tempora nemo dolorum eius, odio ullam deserunt.
                    Cumque error possimus ab facere asperiores nobis cum sapiente soluta! Asperiores autem ullam, natus
                    similique ducimus vero accusamus deserunt incidunt! Maxime ipsum, deleniti accusamus dolor excepturi
                    sapiente minima repellat in ut corrupti voluptatum voluptatibus facere fugiat nesciunt nobis vitae
                    harum quae eum ab! Modi quibusdam aspernatur possimus laudantium quia quisquam, facilis
                    exercitationem molestiae doloribus. Inventore qui temporibus explicabo est aperiam veritatis nobis
                    quidem eligendi. Vero itaque reiciendis quia deleniti in, rerum saepe, iste adipisci porro corrupti
                    error. Sequi optio voluptatem ex debitis assumenda ut dolorum nihil et atque illum asperiores
                    aliquid, quos alias in mollitia consectetur excepturi natus hic! Perspiciatis fuga facilis animi
                    reprehenderit, maxime magni similique quis id soluta. Dignissimos corporis voluptate sint
                    consequuntur?
                </p>
