                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-1">
                                                                ...
                                                                <img id="previewImage" src="" alt="Selected Image" style="display: none; object-fit: cover" class="img-fluid">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-primary w-100" value="Upload" name="submit">Post</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
