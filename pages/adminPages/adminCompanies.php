    ...
    if (isset($_POST["id"])) {
        ...
        try {
            ...
            if ($a > 0) {
                ...
                header("Location: ./adminCompanies.php?success=1");
                exit;
            } else {
                header("Location: ./adminCompanies.php?error=1");
                exit;
            }
        ...
        <div class="col-11 ml-sm-auto col-lg-10 px-4 " style="padding-top: 70px; z-index:5">
            ...
            if (isset($_GET['success'])) {
                ...
                <div class='alert alert-success alert-dismissible fade show' role='alert'>
                    Company <strong>deleted </strong> successfully
                    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                </div>";
                }
            }
                ...
                <tbody>
                    <tr>
                        ...
                        try {
                            ...
                            $query = "SELECT * FROM company LIMIT $start, $rows_per_page";
                            $pstmt = $con->prepare($query);
                            $pstmt->execute();
                        ...
                        ?>
                                ...
                                <th scope="row"><?php echo "C" . $comID; ?></th>
                                <td><?php echo $comname; ?></td>
                                <td><?php echo $comemail; ?></td>
                                <td><?php echo $comemployee; ?></td>
                                <!-- <td><?php echo $comphone; ?></td> -->
                                <td class="d-flex align-items-center p-1">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewmodal1<?php echo $comID; ?>">View </button>
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deletemodel<?php echo $comID; ?>">Delete </button>
                    ...
                    <div class="modal fade shadow my-5" id="viewmodal1<?php echo $comID; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="false">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">

                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel"> <?php echo  $comname . "'s Details" ?>
                                    </h1>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class=" d-flex flex-column align-items-center justify-content-cente ">
                                                <!--avatar-->
                                                <div class="p-3 ">
                                                    <img src="<?php profilepath($compic); ?>" alt="avatar" class="rounded-circle me-2 " style="width: 150px; height: 150px; object-fit: cover" />
                                                </div>
                                                <!--profile content-->
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="d-flex flex-column ">
                                                <h5>Employee</h5>
                                                <p class="fw-bold m-0">
                                                    <?php echo  $comemployee . " employees are working here" ?>
                                                </p>
                                            </div>
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                        <div class="modal fade shadow my-5" id="deletemodel<?php echo $comID; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="false">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">

                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel"> <?php echo  "Confirm to Delete " . $comname . "'s Details" ?>
                                        </h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
            ...
            <?php
                            ...
                            if (!isset($total_rows)) {
                                $total_rows_query = "SELECT COUNT(*) as total FROM company";
