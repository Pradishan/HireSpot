...
<html>
   ...
   <body>
      ...
      <?php echo $seeker->getFirstname() . " " . $seeker->getLastname() ?>
      </div>
      </div>
      <hr>
      <div class="row">
               ...
               <div class="card h-100">
                  <div class="card-body">
                     <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Education</i></h6>
                        ...
                        <p class="fw-bold m-0"><?php echo $seeker->getEducation() ?></p>
