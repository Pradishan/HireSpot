        ...
        <div class="bg-white shadow rounded p-3 input-group-lg">
            <form action="./server/companyLoginProcess.php" method="post">
                ...
                <div class="form-floating my-3">
                    <input type="text" name="companyname" class="form-control" id="floatingInput" placeholder="name@example.com"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="./server/comapanyRegistrationProcess.php" method="post">
                            <div class="modal-body">
                                ...
                                <input type="text" name="companyname" class="form-control my-3" placeholder="Company Name" id="" />
                                ...
                                <input type="text" name="employee" class="form-control my-3" placeholder="Number of employee" id="" />
                            </div>
