...
if (!isset($_SESSION["useID"]) || !isset($_SESSION["username"]) || !isset($_SESSION["email"])) {
...
try {
    ...
    $query = "SELECT * FROM jobseeker WHERE  useID = ? ";
            ...
            <div class="container">
                ...
                <div class="dropdown ">
                    <dvi class="" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <a class="navbar-brand " href="" type="button"> <img src="<?php echo $profil; ?>" alt="avatar"
                    ...
                    <ul class="dropdown-menu border-0 shadow">
                        ...
                        <li><a class="dropdown-item" href="../pages/userProfile.php">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo $profil; ?>" alt="avatar" class="rounded-circle me-2 "
                        ...
                        <div class="bg-white rounded mx-4 px-4">
                            <div class=" d-flex flex-column align-items-center justify-content-cente ">
                                ...
                                <dvi class="mt-4 p-3 " type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <a class="navbar-brand " href="#" type="button"> <img src="<?php echo $profil; ?>"
                        ...
                        for (
                            ...
                            <div class="bg-white shadow rounded mt-3 p-3" sy>
                                ...
                                <div class="d-flex justify-content-between p-2">
                                    <!-- avatar -->
                                    <div class="d-flex">
                                        <img src="https://source.unsplash.com/random/<?php echo $i;
                                        ?>4" alt="avatar" srcset="" class="rounded-circle me-3"
                                ...
                                <div class=" p-2 ">
                                    ...
                                    <div class="pt-2">
                                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eos, voluptates ea aliquam
                                            dignissimos
                                            minus, eius praesentium adipisci tempora voluptate veritatis qui est, officiis totam
                                            enim?</p>
                                    </div>
                                    <!--post image-->
                                    <img src="https://source.unsplash.com/random/<?php echo $i;
                                    ?>7" alt="post" class="img-fluid" style="object-fit: cover">
                                    <!--apply btn-->
                                    <div class="d-flex justify-content-center pt-3">
                                        <button type="button" class="btn btn-primary w-100 my-3" data-bs-toggle="modal"
                                            data-bs-target="#applymodal<?php echo $i;
                                            ?>"> Apply now
                                        </button>
                                    </div>
                                    ...
                                    <form action="../server/post.php" method="post" enctype="multipart/form-data">
                                        <div class="modal fade shadow my-5" id="applymodal<?php echo $i;
                    ...
                    <div class="d-none d-xxl-block h-100 fixed-top  end-0 scrallbar me-5"
                        ...
                        <div class="">
                            ...
                            <div class="bg-white rounded d-flex align-items-center justify-content-between p-3 m-3">
                                <div class="d-flex">
                                    <!--avatar of company-->
                                    <img src="https://source.unsplash.com/random/11" alt="avatar" class="rounded me-2 "
                                        style="width: 48px; height: 48px; object-fit: cover" />
                                    <!--job-->
                                    <div class="">
                            ...
                            <div class="bg-white rounded d-flex align-items-center justify-content-between p-3 m-3">
                                <div class="d-flex">
                                    <!--avatar of company-->
                                    <img src="https://source.unsplash.com/random/12" alt="avatar" class="rounded me-2 "
                                        style="width: 48px; height: 48px; object-fit: cover" />
                                    <!--job-->
                                    <div class="">
                                        <p class="fw-bold mb-0">Software Engeneer</p>
                            ...
                            <div class="bg-white rounded d-flex align-items-center justify-content-between p-3 m-3">
                                <div class="d-flex">
                                    <!--avatar of company-->
                                    <img src="https://source.unsplash.com/random/13" alt="avatar" class="rounded me-2 "
                                        style="width: 48px; height: 48px; object-fit: cover" />
                                    <!--job-->
                                    <div class="">
                                        <p class="fw-bold mb-0">Software Engeneer</p>
