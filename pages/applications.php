...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand " href="#"><img src="../img/logo.png" width="137px" height="43px"
                    alt="HireSpot" /></a>
                    ...
                    <div class="candidate-list-widgets mb-4">
                        <form action="#" class="">
                            <div class="g-2 row">
                                ...
                                <div class="col-lg-3">
                                    <div>
                                        <a class="btn btn-primary" href="#"><i class="uil uil-filter"></i> Filter</a><a
                                            class="btn btn-success ms-2" href="#"><i class="uil uil-cog"></i>
                                            Advance</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="align-items-center row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="mt-2 mt-lg-0 d-flex flex-wrap align-items-start gap-3">
                                            <span class="btn btn-primary fs-14 mt-1">View Detail</span><span
                                                class="btn btn-primary fs-14 mt-1">Download Application</span><span
                                                class="btn btn-success fs-14 mt-1">Accept</span><span
                                                class="btn btn-danger  fs-14 mt-1">Reject</span>
                                        </div>
                                    </div>
                                </div>
