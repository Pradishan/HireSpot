...
$searchjobCategory = $_GET['searchjobCategory'];
            ...
            <div class="container">
                        ...
                        <li class="nav-item">
                            ...
                            <form class="d-flex" role="search">
                                <select class="form-control me-2 border-0" id="inputGroupSelect01" name="searchjobCategory"
                                    ...
                                    <option selected>
                                        <?php if (isset($_GET['searchjobCategory']) && !empty($_GET['searchjobCategory'])) {
                ...
                <div class="dropdown ">
                    <dvi class="" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <a class="navbar-brand " href="" type="button"> <img src="<?php profilepath($profilePic); ?>"
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 pb-5">
                    <div class="d-flex justify-content-center flex-column w-100 mx-auto mt-3"
                        ...
                        if (isset($_GET['searchjobCategory']) && !empty($_GET['searchjobCategory'])) {
                            echo '<h3' . $searchjobCategory . '</h3>';
                        }
                        if (isset($_GET['error'])) {
                            if ($_GET['error'] == 1) {
                                echo "
